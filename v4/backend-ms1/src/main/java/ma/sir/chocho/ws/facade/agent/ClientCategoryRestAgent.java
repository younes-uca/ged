package  ma.sir.chocho.ws.facade.agent;
...
import ma.sir.chocho.ws.converter.ClientCategoryConverter;
import ma.sir.chocho.ws.dto.ClientCategoryDto;
import ma.sir.chocho.zynerator.controller.AbstractController;
import ma.sir.chocho.zynerator.dto.AuditEntityDto;
import ma.sir.chocho.zynerator.util.PaginatedList;
...
import ma.sir.chocho.zynerator.process.Result;


import org.springframework.web.multipart.MultipartFile;
import ma.sir.chocho.zynerator.dto.FileTempDto;

@Api("Manages clientCategory services")
@RestController
@RequestMapping("/api/agent/clientCategory/")
public class ClientCategoryRestAgent  extends AbstractController<ClientCategory, ClientCategoryDto, ClientCategoryHistory, ClientCategoryCriteria, ClientCategoryHistoryCriteria, ClientCategoryAgentService, ClientCategoryConverter> {
    ...
    public ClientCategoryRestAgent (ClientCategoryAgentService service, ClientCategoryConverter converter) {
