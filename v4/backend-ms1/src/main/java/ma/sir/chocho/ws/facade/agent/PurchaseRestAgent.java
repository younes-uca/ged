...
import ma.sir.chocho.service.facade.agent.PurchaseAgentService;
import ma.sir.chocho.ws.converter.PurchaseConverter;
import ma.sir.chocho.ws.dto.PurchaseDto;
...
@RestController
@RequestMapping("/api/agent/purchase/")
public class PurchaseRestAgent  extends AbstractController<Purchase, PurchaseDto, PurchaseHistory, PurchaseCriteria, PurchaseHistoryCriteria, PurchaseAgentService, PurchaseConverter> {
    ...
    public PurchaseRestAgent (PurchaseAgentService service, PurchaseConverter converter) {
