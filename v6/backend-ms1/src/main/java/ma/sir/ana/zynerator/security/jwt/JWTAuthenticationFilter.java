package ma.sir.ana.zynerator.security.jwt;
...
import ma.sir.ana.AnaApplication;
import ma.sir.ana.zynerator.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = AnaApplication.getCtx().getBean(UserService.class);
