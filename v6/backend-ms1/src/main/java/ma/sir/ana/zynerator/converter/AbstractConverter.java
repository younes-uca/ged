package ma.sir.ana.zynerator.converter;


import ma.sir.ana.zynerator.bean.Etablissement;
import ma.sir.ana.zynerator.dto.EtablissementDto;

import ma.sir.ana.zynerator.util.ListUtil;
import ma.sir.ana.zynerator.audit.AuditBusinessObject;
import ma.sir.ana.zynerator.bean.BusinessObject;
import ma.sir.ana.zynerator.dto.AuditBaseDto;
import ma.sir.ana.zynerator.dto.BaseDto;
import ma.sir.ana.zynerator.util.DateUtil;
import ma.sir.ana.zynerator.util.RefelexivityUtil;
import ma.sir.ana.zynerator.util.StringUtil;
import ma.sir.ana.zynerator.util.Utils;
