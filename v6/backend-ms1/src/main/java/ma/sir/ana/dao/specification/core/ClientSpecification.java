...
public class ClientSpecification extends  AbstractSpecification<ClientCriteria, Client>  {
    ...
    public void constructPredicates() {
        ...
        addPredicate("dateRegistration", criteria.getDateRegistration(), criteria.getDateRegistrationFrom(), criteria.getDateRegistrationTo());
        addPredicateBigDecimal("nombreEnfant", criteria.getNombreEnfant(), criteria.getNombreEnfantMin(), criteria.getNombreEnfantMax());
