...
const List = () => {
    ...
    const fetchItems = async (criteria) => {
        try {
            const response = await AcessManagementAdminService.findPaginatedByCriteria(criteria);
   ...
   const hideDeleteItemsDialog = () => {
    ...
    const deleteItem = async () => {
        try{
            ...
            setItems(_items);
            MessageService.showSuccess(toast, 'AcessManagement Deleted');
        } catch (error) {
            MessageService.showError(toast, 'AcessManagement Deletion Prob');
        }
    };
    ...
    const deleteSelectedItems = async () => {
        await AcessManagementAdminService.deleteList(selectedItems);
        let _items = items.filter((val) => !selectedItems.includes(val));
        setItems(_items);
        setDeleteItemsDialog(false);
        setSelectedItems(null);
        MessageService.showSuccess(toast, 'AcessManagements Deleted');
    };
