...
<TabPanel header="Client">
    <div className="formgrid grid">
        ...
        <div className="field col-6">
            ...
            <Calendar id="dateRegistration" value={selectedItem?.dateRegistration} disabled dateFormat="dd/mm/yy" showTime />
        </div>

                <div className="field col-6">
                    <label htmlFor="nombreEnfant">NombreEnfant</label>
                    <InputNumber id="nombreEnfant" value={item.nombreEnfant} disabled/>
                </div>

                <div className="field col-6">
                    <label htmlFor="clientCategory">ClientCategory</label>
                    <Dropdown  id="clientCategoryDropdown"  value={selectedItem?.clientCategory?.reference}  disabled  />
                </div>
        </div>
</TabPanel>
</TabView>
