        ...
        <div className="col-12">
            <div className="card">
                ...
                <Card>
                    <div className="search-container">
                        <div className="grid">
                            ...
                            <span className="p-float-label mr-3 align-search-items mt-4">
                                <Dropdown id="7" value={criteria.documentState} options={documentStates} onChange={(e) => setCriteria({ ...criteria, documentState: e.target.value })} optionLabel="libelle" filter showClear placeholder="DocumentState" />
                            </span>
                            <span className="p-float-label mr-3 align-search-items mt-4">
                            ...
                            <span className="p-float-label mr-3 align-search-items mt-4">
                                <InputText id="10" value={criteria.description} onChange={(e) => setCriteria({ ...criteria, description: e.target.value })} />
                                <label htmlFor="10">Description</label>
                            </span>
                            <span className="p-float-label mr-3 align-search-items mt-4">
                                <Dropdown id="11" value={criteria.utilisateur} options={utilisateurs} onChange={(e) => setCriteria({ ...criteria, utilisateur: e.target.value })} optionLabel="name" filter showClear placeholder="Utilisateur" />
                            </span>
                            <span className="p-float-label mr-3 align-search-items mt-4">
                                <Dropdown id="14" value={criteria.entiteAdministrative} options={entiteAdministratives} onChange={(e) => setCriteria({ ...criteria, entiteAdministrative: e.target.value })} optionLabel="libelle" filter showClear placeholder="EntiteAdministrative" />
                            </span>
                        </div>
                ...
                <DataTable ref={dt} value={items} selection={selectedItems} onSelectionChange={(e) => setSelectedItems(e.value as DocumentDto[])} dataKey="id" className="datatable-responsive" globalFilter={globalFilter} header={header} responsiveLayout="scroll" >
                    ...
                    <Column field="uploadDate | date :'dd/MM/yyyy HH:mm'" header="UploadDate" sortable></Column>
                    
                    
                    <Column field="dateLastUpdate | date :'dd/MM/yyyy HH:mm'" header="DateLastUpdate" sortable></Column>
                    ...
                    <Column field="documentState.libelle" header="DocumentState" sortable></Column>
