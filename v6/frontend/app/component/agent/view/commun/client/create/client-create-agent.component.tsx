...
const Create = ({visible, onClose, add, showToast, list}) => {
    ...
    const saveItem = async () => {
        setSubmitted(true);
        if (isFormValid()) {
            const response = await ClientAgentService.save(item);
            add(response.data);
        ...
        <TabView activeIndex={activeIndex} onTabChange={onTabChange}>
            <TabPanel header="Client">
                <div className="formgrid grid">
                    ...
                    <Calendar id="dateRegistration" value={item.dateRegistration} onChange={(e) => onInputDateChange(e, 'dateRegistration')} dateFormat="dd/mm/yy" showTime />
                    </div>
                    <div className="field col-6">
                    <label htmlFor="nombreEnfant">NombreEnfant</label>
                    <InputNumber id="nombreEnfant" value={item.nombreEnfant} onChange={(e) => onInputNumerChange(e, 'nombreEnfant')} />
                    </div>
                    <div className="field col-6">
