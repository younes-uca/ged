...
import {ClientAgentService} from 'app/controller/service/agent/ClientAgentService.service';
...
import Edit from '../edit/client-edit-agent.component';
import Create from '../create/client-create-agent.component';
import View from '../view/client-view-agent.component';
...
const List = () => {
           ...
           const fetchData = async () => {
            try {
                const [clientCategorysResponse ] = await Promise.all<ClientCategoryResponse>([
                    ClientCategoryAgentService.getList(),
                ]);
    ...
    const fetchItems = async (criteria) => {
        try {
            const response = await ClientAgentService.findPaginatedByCriteria(criteria);
   ...
   const hideDeleteItemsDialog = () => {
    ...
    const deleteSelectedItems = async () => {
        await ClientAgentService.deleteList(selectedItems);
