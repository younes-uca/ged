...
type DocumentCategorieFieldRuleEditAgentType = {
    ...
    service: DocumentCategorieFieldRuleAgentService,
    t: TFunction
}
const Edit: React.FC<DocumentCategorieFieldRuleEditAgentType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
