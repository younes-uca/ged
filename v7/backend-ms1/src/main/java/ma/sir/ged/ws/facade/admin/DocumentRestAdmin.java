...
public class DocumentRestAdmin  extends AbstractController<Document, DocumentDto, DocumentHistory, DocumentCriteria, DocumentHistoryCriteria, DocumentAdminService, DocumentConverter> {
    ...
    @ApiOperation("find by proprietaire id")
    @GetMapping("proprietaire/id/{id}")
    public List<Document> findByProprietaireId(@PathVariable Long id){
        return service.findByProprietaireId(id);
    }
    @ApiOperation("delete by proprietaire id")
    ...
    @ApiOperation("find by entiteAdministrativeProprietaire id")
    @GetMapping("entiteAdministrativeProprietaire/id/{id}")
    public List<Document> findByEntiteAdministrativeProprietaireId(@PathVariable Long id){
        return service.findByEntiteAdministrativeProprietaireId(id);
    }
    @ApiOperation("delete by entiteAdministrativeProprietaire id")
    @DeleteMapping("entiteAdministrativeProprietaire/id/{id}")
    public int deleteByEntiteAdministrativeProprietaireId(@PathVariable Long id){
        return service.deleteByEntiteAdministrativeProprietaireId(id);
    }
