...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 30 juil. 2023 à 14:20
...
CREATE TABLE `document` (
  ...
  `entite_administrative_proprietaire` bigint(20) DEFAULT NULL,
  `proprietaire` bigint(20) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `document`
  ...
  ADD KEY `FKqltpgif7fc8c63xn36yik0jmi` (`entite_administrative_proprietaire`),
  ADD KEY `FK3ul3xfdq63moixh116bjci7mu` (`proprietaire`);
