...
import DocumentCategorieFieldRulesList from 'app/component/admin/view/fielddoc/document-categorie-field-rule/list/document-categorie-field-rule-list-admin.component';
