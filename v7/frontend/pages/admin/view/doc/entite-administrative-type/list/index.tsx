...
import EntiteAdministrativeTypesList from 'app/component/admin/view/doc/entite-administrative-type/list/entite-administrative-type-list-admin.component';
