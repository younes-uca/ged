...
return(
    <Dialog visible={visible} style={{width: '70vw'}} header="DocumentState" modal className="p-fluid" footer={itemDialogFooter} onHide={hideDialog}>
        <TabView activeIndex={activeIndex} onTabChange={onTabChange}>
            <TabPanel header="DocumentState">
