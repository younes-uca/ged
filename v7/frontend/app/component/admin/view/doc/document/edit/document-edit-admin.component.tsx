            ...
            <TabPanel header="Document">
                <div className="formgrid grid">
                    ...
                    <div className="field col-6">
                        ...
                        <Dropdown  id="proprietaireDropdown"  value={item ? item.proprietaire : ''} options={proprietaires} onChange={(e) => onDropdownChange(e, 'proprietaire')}   placeholder="Sélectionnez un proprietaire" filter filterPlaceholder="Rechercher un proprietaire" optionLabel="nom" />
                    </div>
                    <div className="field col-6">
                        <div  class="label-inputswitch">
                    ...
                    <div className="field col-6">
                        ...
                        <Dropdown  id="entiteAdministrativeProprietaireDropdown"  value={item ? item.entiteAdministrativeProprietaire : ''} options={entiteAdministrativeProprietaires} onChange={(e) => onDropdownChange(e, 'entiteAdministrativeProprietaire')}   placeholder="Sélectionnez un entiteAdministrativeProprietaire" filter filterPlaceholder="Rechercher un entiteAdministrativeProprietaire" optionLabel="libelle" />
                    </div>
                </div>
            </TabPanel>
