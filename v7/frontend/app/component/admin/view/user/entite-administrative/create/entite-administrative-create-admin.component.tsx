        ...
        <TabView activeIndex={activeIndex} onTabChange={onTabChange}>
            <TabPanel header="Entite administrative">
                <div className="formgrid grid">
                    ...
                    <Dropdown  id="entiteAdministrativeTypeDropdown"  value={item.entiteAdministrativeType} options={entiteAdministrativeTypes} onChange={(e) => onDropdownChange(e, 'entiteAdministrativeType')}   placeholder="Sélectionnez un entiteAdministrativeType" filter filterPlaceholder="Rechercher un entiteAdministrativeType" optionLabel="libelle" />
                    </div>
                </div>
            </TabPanel>
        </TabView>
