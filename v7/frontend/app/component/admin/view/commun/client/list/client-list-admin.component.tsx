                    ...
                    <div className="search-container">
                        <div className="grid">
                            ...
                            <span className="mr-3 align-search-items mt-4">
                                <Dropdown id="3" value={criteria.clientCategory} options={clientCategorys} onChange={(e) => setCriteria({ ...criteria, clientCategory: e.target.value })} optionLabel="reference" filter showClear placeholder="ClientCategory" filterPlaceholder="ClientCategory"/>
                            </span>
                        </div>
