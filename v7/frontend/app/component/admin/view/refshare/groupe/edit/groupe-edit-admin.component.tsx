...
return(
    <Dialog visible={visible} style={{width: '70vw'}} header="Groupe" modal className="p-fluid" footer={itemDialogFooter} onHide={hideDialog}>
        <TabView activeIndex={activeIndex} onTabChange={onTabChange}>
            ...
            <TabPanel header="Groupe utilisateurs">
                <TabView activeIndex={activeTab} onTabChange={(e) => setActiveTab(e.index)}>
                    <TabPanel header="Creation">
                        <div className="grid">
                            ...
                            <div className="field col-6">
                                <label htmlFor="dateAjout">Date ajout</label>
                            ...
                            <div className="field col-6">
                                <label htmlFor="etatUtilisateur">Etat utilisateur</label>
                            ...
                            <div className="field col-6">
                                <label htmlFor="roleUtilisateur">Role utilisateur</label>
                    ...
                    <TabPanel header="Liste">
                        <div className="card">
                            <DataTable value={item.groupeUtilisateurs} tableStyle={{minWidth: '50rem'}} dataKey="id">
                                ...
                                <Column field="dateAjout" header="Date ajout"></Column>
                                <Column field="etatUtilisateur.libelle" header="Etat utilisateur"></Column>
                                <Column field="roleUtilisateur.libelle" header="Role utilisateur"></Column>
