...
return(
<Dialog visible={visible} style={{width: '70vw'}} header="EtatUtilisateur Details" modal className="p-fluid" footer={itemDialogFooter} onHide={hideDialog} >
<TabView activeIndex={activeIndex} onTabChange={onTabChange}>
<TabPanel header="Etat utilisateur">
