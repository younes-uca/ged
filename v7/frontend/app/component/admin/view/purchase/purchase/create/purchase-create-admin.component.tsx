...
return(
    <Dialog visible={visible} style={{width: '70vw'}} header="Purchase" modal className="p-fluid" footer={itemDialogFooter} onHide={hideDialog} >
        <TabView activeIndex={activeIndex} onTabChange={onTabChange}>
            <TabPanel header="Purchase">
                <div className="formgrid grid">
                    <div className="field col-6">
                        <label htmlFor="reference">{t("purchaseReference")}</label>
                    ...
                    <div className="field col-6">
                        <label htmlFor="purchaseDate">{t("purchasePurchaseDate")}</label>
                    ...
                    <div className="field col-6">
                        <label htmlFor="image">{t("purchaseImage")}</label>
                    ...
                    <div className="field col-6">
                        <label htmlFor="total">{t("purchaseTotal")}</label>
                    ...
                    <div className="field col-6">
                        <label htmlFor="client">{t("purchaseClient")}</label>
            ...
            <TabPanel header="{t("purchasePurchaseItems")}">
                <TabView activeIndex={activeTab} onTabChange={(e) => setActiveTab(e.index)}>
                    <TabPanel header="Creation">
                        <div className="grid">
                            <div className="field col-6">
                                <label htmlFor="product">{t("purchaseItemProduct")}</label>
                    ...
                    <DataTable value={item.purchaseItems} tableStyle={{minWidth: '50rem'}} dataKey="id">
                        <Column field="product.reference" header="{t("purchaseItemProduct")}"></Column>
                        <Column field="price" header="{t("purchaseItemPrice")}"></Column>
                        <Column field="quantity" header="{t("purchaseItemQuantity")}"></Column>
