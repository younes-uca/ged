                    ...
                    <div className="search-container">
                        <div className="grid">
                            ...
                            <span className="mr-3 align-search-items mt-4">
                                <Dropdown id="6" value={criteria.client} options={clients} onChange={(e) => setCriteria({ ...criteria, client: e.target.value })} optionLabel="fullName" filter showClear placeholder="Client" filterPlaceholder="Client"/>
                            </span>
                        </div>
