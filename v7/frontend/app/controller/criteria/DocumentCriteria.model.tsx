...
export class DocumentCriteria  extends  BaseCriteria {
  ...
  public proprietaire: UtilisateurCriteria ;
  public proprietaires: Array<UtilisateurCriteria> ;
  public entiteAdministrative: EntiteAdministrativeCriteria ;
  public entiteAdministratives: Array<EntiteAdministrativeCriteria> ;
  public entiteAdministrativeProprietaire: EntiteAdministrativeCriteria ;
  public entiteAdministrativeProprietaires: Array<EntiteAdministrativeCriteria> ;
    ...
    constructor() {
        ...
        this.proprietaire = new UtilisateurCriteria() ;
        this.proprietaires = new Array<UtilisateurCriteria>() ;
        ...
        this.entiteAdministrativeProprietaire = new EntiteAdministrativeCriteria() ;
        this.entiteAdministrativeProprietaires = new Array<EntiteAdministrativeCriteria>() ;
    }
