...
import Create from '../create/client-category-create-admin.component';
import View from '../view/client-category-view-admin.component';
...
const List = () => {
    ...
    const fetchItems = async (criteria) => {
        try {
            const response = await ClientCategoryService.findPaginatedByCriteria(criteria);
   ...
   const hideDeleteItemsDialog = () => {
    ...
    const deleteItem = async () => {
        try{
            ...
            setItems(_items);
            MessageService.showToast(toast, { severity: 'success', summary: 'Successful', detail: 'ClientCategory Deleted', life: 3000 });
        } catch (error) {
            console.log(error);
        }
    };
    ...
    const deleteSelectedItems = async () => {
        await ClientCategoryService.deleteList(selectedItems);
        let _items = items.filter((val) => !selectedItems.includes(val));
        setItems(_items);
        setDeleteItemsDialog(false);
        setSelectedItems(null);
        MessageService.showToast(toast, { severity: 'success', summary: 'Successful', detail: 'ClientCategorys Deleted', life: 3000 });
    };
