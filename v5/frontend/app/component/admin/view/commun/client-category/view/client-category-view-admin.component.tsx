...
return(
<Dialog visible={visible} style={{width: '70vw'}} header="ClientCategory Details" modal className="p-fluid" footer={itemDialogFooter} onHide={hideDialog} >
    ...
    <div className="formgrid grid">
            ...
            <div className="field col-6">
                ...
                <div className="field col-6">
                    ...
                    <InputNumber id="socialIndex" value={item.socialIndex} disabled/>
                </div>
