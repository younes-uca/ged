...
const Edit = ({visible, onClose, showToast, selectedItem, update}) => {
    ...
    const editItem = async () => {
        setSubmitted(true);
        if (isFormValid()) {
            const response = await UtilisateurService.update(item);
            ...
            <TabPanel header="Utilisateur">
                <div className="formgrid grid">
                    ...
                    <div className="field col-6">
                        ...
                        <InputText id="name" value={item ? item.name : ''} onChange={(e) => onInputTextChange(e, 'name')} required autoFocus className={classNames({'p-invalid': submitted && !item.name})} />
