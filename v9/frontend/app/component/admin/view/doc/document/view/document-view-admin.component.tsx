...
const View = ({visible,onClose,selectedItem, t}) => {
    ...
    const parseDate  = (field,formatPatternInput,formatPatternOutput) => {
        const originalDate = parse(field, formatPatternInput, new Date());
        return format(originalDate, formatPatternOutput);
    };

    const dateTemplate = (field) => {
        return (rowData) => {
    ...
    console.log("dateLastUpdate value ",selectedItem?.dateLastUpdate)
    console.log("dateLastUpdate type ",typeof selectedItem?.dateLastUpdate)
return(
...
<TabPanel header={t("documentTabPan")}>
    <div className="formgrid grid">
        ...
        <div className="field col-6">
            ...
            <Calendar id="dateLastUpdate" value={new Date(selectedItem?.dateLastUpdate)} disabled dateFormat="dd/mm/yy" showIcon={true} />
        </div>
