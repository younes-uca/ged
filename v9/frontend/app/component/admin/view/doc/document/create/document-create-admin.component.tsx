...
const Create = ({visible, onClose, add, showToast, list, t}) => {
    ...
    const dateTemplate = (field: string) => {
        return (rowData: any) => {
            return rowData[field].toLocaleDateString();
        };
    };
                        ...
                        <TabPanel header={t("list")}>
                            <div className="card">
                                <DataTable value={item.documentPartageGroupes} tableStyle={{minWidth: '50rem'}}
                                    ...
                                    <Column field="dateShare" header={t("documentPartageGroupeDateShare")}  body={dateTemplate("dateShare")} ></Column>
                        ...
                        <TabPanel header={t("list")}>
                            <div className="card">
                                <DataTable value={item.documentPartageUtilisateurs} tableStyle={{minWidth: '50rem'}}
                                    ...
                                    <Column field="dateShare"
                                            header={t("documentPartageUtilisateurDateShare")}></Column>
                                    <Column field="accessShare.libelle"
