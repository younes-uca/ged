...
const List = () => {
    ...
    const fetchItems = async (criteria) => {
        try {
            const response = await DocumentCategorieAdminService.findPaginatedByCriteria(criteria);
   ...
   const hideDeleteItemsDialog = () => {
    ...
    const deleteItem = async () => {
        try{
            await DocumentCategorieAdminService.delete(selectedItem?.id);
            setDeleteItemDialog(false);
            setItem(emptyItem);
    ...
    const deleteSelectedItems = async () => {
        await DocumentCategorieAdminService.deleteList(selectedItems);
