package ma.sir.easy.zynerator.security.jwt;
...
import ma.sir.easy.EasyApplication;
import ma.sir.easy.zynerator.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = EasyApplication.getCtx().getBean(UserService.class);
