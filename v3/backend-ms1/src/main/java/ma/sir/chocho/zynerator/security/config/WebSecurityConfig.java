package ma.sir.chocho.zynerator.security.config;
...
import ma.sir.chocho.zynerator.security.jwt.JWTAuthenticationFilter;
import ma.sir.chocho.zynerator.security.jwt.JWTAuthorizationFiler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/actuator/info").permitAll();
            ...
            http.authorizeRequests().antMatchers("/api/agent/login").permitAll();
            http.authorizeRequests().antMatchers("/api/admin/login").permitAll();
            http.authorizeRequests().antMatchers("/api/agent/").hasAnyAuthority(AuthoritiesConstants.AGENT);
