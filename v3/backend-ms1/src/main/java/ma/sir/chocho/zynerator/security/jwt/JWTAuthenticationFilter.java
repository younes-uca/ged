package ma.sir.chocho.zynerator.security.jwt;
...
import ma.sir.chocho.ChochoApplication;
import ma.sir.chocho.zynerator.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = ChochoApplication.getCtx().getBean(UserService.class);
