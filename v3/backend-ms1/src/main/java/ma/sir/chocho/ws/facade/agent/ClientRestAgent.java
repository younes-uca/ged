...
import ma.sir.chocho.ws.converter.ClientConverter;
import ma.sir.chocho.ws.dto.ClientDto;
...
@RestController
@RequestMapping("/api/agent/client/")
public class ClientRestAgent  extends AbstractController<Client, ClientDto, ClientHistory, ClientCriteria, ClientHistoryCriteria, ClientAgentService, ClientConverter> {
    ...
    public ClientRestAgent (ClientAgentService service, ClientConverter converter) {
