...
const List = () => {
   ...
   const hideDeleteItemsDialog = () => {
    ...
    const deleteSelectedItems = async () => {
        await service.deleteList(selectedItems);
    ...
    <div className="grid crud-demo">
        <div className="col-12">
            <div className="card">
                ...
                {showCreateDialog && <Create visible={showCreateDialog} onClose={() => setShowCreateDialog(false)} add={add} showToast={toast} list={items}  t={t} service={service} />}
