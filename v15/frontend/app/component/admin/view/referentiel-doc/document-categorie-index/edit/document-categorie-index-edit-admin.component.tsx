            ...
            <TabPanel header={t("documentCategorieIndex.tabPan")}>
                <div className="formgrid grid">
                    <div className="field col-6">
                        ...
                        <Dropdown  id="indexElementDropdown"  value={item ? item.indexElement : ''} options={indexElements} onChange={(e) => onDropdownChange(e, 'indexElement')}   placeholder="Sélectionnez un indexElement" filter filterPlaceholder="Rechercher un indexElement" optionLabel="libelle" showClear />
                    </div>
                    <div className="field col-6">
