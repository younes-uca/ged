...
const Edit: React.FC<DocumentStateEditAdminType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
    ...
    const {
        ...
        parseToIsoFormat,
        adaptDate
        } = useEditHook<DocumentStateDto, DocumentStateCriteria>({list, selectedItem, onClose, update, showToast,service, t, isFormValid})
