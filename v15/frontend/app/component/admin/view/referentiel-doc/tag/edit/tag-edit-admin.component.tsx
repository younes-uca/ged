...
type TagEditAdminType = {
    ...
    list: TagDto[],
    service: TagAdminService,
    t: TFunction
}
const Edit: React.FC<TagEditAdminType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
    ...
    const {
        ...
        parseToIsoFormat,
        adaptDate
        } = useEditHook<TagDto, TagCriteria>({list, selectedItem, onClose, update, showToast,service, t, isFormValid})
