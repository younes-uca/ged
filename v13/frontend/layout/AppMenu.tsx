                ...
                },
                {
                    ...
                    items: [
                     ...
                     to: '/admin/view/referentiel-doc/document-state/list'
                      ...
                      {
                      label: 'Liste document index element state',
                     to: '/admin/view/referentiel-doc/document-index-element-state/list'
                      },
                      {
                ...
                },
                {
                    ...
                    items: [
                     ...
                     to: '/agent/view/referentiel-doc/document-categorie/list'
                      ...
                      {
                      label: 'Liste document categorie model',
                     to: '/agent/view/referentiel-doc/document-categorie-model/list'
                      },
                      {
                      label: 'Liste document categorie index',
                     to: '/agent/view/referentiel-doc/document-categorie-index/list'
                      },
                      {
                      label: 'Liste document categorie index rule',
                     to: '/agent/view/referentiel-doc/document-categorie-index-rule/list'
                      },
                      {
                      label: 'Liste index element',
                     to: '/agent/view/referentiel-doc/index-element/list'
                      },
                    ]
                    },
            ]
