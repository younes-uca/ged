...
type DocumentCategorieIndexRuleCreateAgentType = {
    visible: boolean,
    onClose: () => void,
...
const Create: React.FC<DocumentCategorieIndexRuleCreateAgentType> = ({visible, onClose, add, showToast, list, service, t}) => {
