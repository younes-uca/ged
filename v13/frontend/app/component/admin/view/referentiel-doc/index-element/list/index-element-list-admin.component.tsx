...
import Edit from '../edit/index-element-edit-admin.component';
import Create from '../create/index-element-create-admin.component';
import View from '../view/index-element-view-admin.component';
...
const List = () => {
    ...
    const service = new IndexElementAdminService();
    ...
    <div className="grid crud-demo">
        <div className="col-12">
            <div className="card">
                ...
                <DataTable ref={dt} value={items} selection={selectedItems} onSelectionChange={(e) => setSelectedItems(e.value as IndexElementDto[])} dataKey="id" className="datatable-responsive" globalFilter={globalFilter} header={header} responsiveLayout="scroll" >
                    <Column selectionMode="multiple" headerStyle={{ width: '4rem' }}> </Column>
                    
                    <Column field="code" header={t("indexElement.code")} sortable></Column>
                ...
                <Dialog visible={deleteItemDialog} style={{width: '450px'}} header={t("confirm")} modal footer={deleteItemDialogFooter} onHide={hideDeleteItemDialog}>
                    ...
                    {item && (<span>{t("deleteIndexElementConfirmationMessage")} <b>{item.libelle}</b>?</span>)}
                    </div>
                </Dialog>
