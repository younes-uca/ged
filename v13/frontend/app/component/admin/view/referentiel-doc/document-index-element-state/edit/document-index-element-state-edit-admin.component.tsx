...
type DocumentIndexElementStateEditAdminType = {
    visible: boolean,
    onClose: () => void,
    showToast: React.Ref<Toast>,
    selectedItem: DocumentIndexElementStateDto
    update: (item: DocumentIndexElementStateDto) => void,
    list: DocumentIndexElementStateDto[],
    service: DocumentIndexElementStateAdminService,
    t: TFunction
}
const Edit: React.FC<DocumentIndexElementStateEditAdminType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
    ...
    const {
        ...
        parseToIsoFormat,
        adaptDate
        } = useEditHook<DocumentIndexElementStateDto, DocumentIndexElementStateCriteria>({list, selectedItem, onClose, update, showToast,service, t, isFormValid})
