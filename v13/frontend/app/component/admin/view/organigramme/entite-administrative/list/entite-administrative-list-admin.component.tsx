            ...
            <div className="card">
                ...
                <Card title={t("search")} className="mb-5">
                        <div className="grid">
                            ...
                            <div className="flex flex-column col-3">
                                <label className="mb-1"  htmlFor="2">{t("entiteAdministrative.codeEntiteAdminParent")}</label>
                            ...
                            <div className="flex flex-column col-3">
                                <label className="mb-1"  htmlFor="6">{t("entiteAdministrative.utilisateurPlaceHolder")}</label>
                                <Dropdown id="6" value={criteria.utilisateur} options={utilisateurs} onChange={(e) => setCriteria({ ...criteria, utilisateur: e.target.value })} optionLabel="nom" filter showClear/>
                            </div>
                            <div className="flex flex-column col-3">
