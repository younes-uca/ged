                    ...
                    <TabPanel header={t("creation")}>
                        <div className="grid">
                            ...
                            <div className="field col-5">
                                ...
                                <Dropdown id="documentIndexElementStateDropdown" value={documentIndexElements.documentIndexElementState} options={documentIndexElementStates} onChange={(e) => onDropdownChangeDocumentIndexElements(e, 'documentIndexElementState')}    placeholder={t("documentIndexElement.documentIndexElementStatePlaceHolder")} filter filterPlaceholder={t("documentIndexElement.documentIndexElementStatePlaceHolderFilter")}  optionLabel="libelle" />
                             </div>
