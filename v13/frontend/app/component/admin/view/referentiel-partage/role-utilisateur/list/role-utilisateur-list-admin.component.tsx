...
const List = () => {
    ...
    const emptyCriteria = new RoleUtilisateurCriteria();
    const service = new RoleUtilisateurAdminService();
    ...
    } = useListHook<RoleUtilisateurDto, RoleUtilisateurCriteria>({ emptyItem, emptyCriteria,service, t})
        ...
        <div className="col-12">
            <div className="card">
                ...
                <Card title={t("search")} className="mb-5">
                        <div className="grid">
                            <div className="flex flex-column col-3">
                                <label className="mb-1"  htmlFor="1">{t("roleUtilisateur.code")}</label>
                                <InputText id="1" value={criteria.code} onChange={(e) => setCriteria({ ...criteria, code: e.target.value })} />
                            </div>
                            <div className="flex flex-column col-3">
                                <label className="mb-1"  htmlFor="2">{t("roleUtilisateur.libelle")}</label>
                ...
                <DataTable ref={dt} value={items} selection={selectedItems} onSelectionChange={(e) => setSelectedItems(e.value as RoleUtilisateurDto[])} dataKey="id" className="datatable-responsive" globalFilter={globalFilter} header={header} responsiveLayout="scroll" >
                    ...
                    <Column field="code" header={t("roleUtilisateur.code")} sortable></Column>
                    
                    
                    <Column field="libelle" header={t("roleUtilisateur.libelle")} sortable></Column>
