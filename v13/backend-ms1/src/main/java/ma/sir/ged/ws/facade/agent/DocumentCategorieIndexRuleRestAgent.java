...
@RestController
@RequestMapping("/api/agent/documentCategorieIndexRule/")
public class DocumentCategorieIndexRuleRestAgent  extends AbstractController<DocumentCategorieIndexRule, DocumentCategorieIndexRuleDto, DocumentCategorieIndexRuleHistory, DocumentCategorieIndexRuleCriteria, DocumentCategorieIndexRuleHistoryCriteria, DocumentCategorieIndexRuleAgentService, DocumentCategorieIndexRuleConverter> {
    ...
    public DocumentCategorieIndexRuleRestAgent (DocumentCategorieIndexRuleAgentService service, DocumentCategorieIndexRuleConverter converter) {
