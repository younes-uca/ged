...
@Api("Manages documentIndexElement services")
@RestController
...
public class DocumentIndexElementRestAdmin  extends AbstractController<DocumentIndexElement, DocumentIndexElementDto, DocumentIndexElementHistory, DocumentIndexElementCriteria, DocumentIndexElementHistoryCriteria, DocumentIndexElementAdminService, DocumentIndexElementConverter> {
    ...
    @ApiOperation("upload one documentIndexElement")
    @RequestMapping(value = "upload", method = RequestMethod.POST, consumes = "multipart/form-data")
    public ResponseEntity<FileTempDto> uploadFileAndGetChecksum(@RequestBody MultipartFile file) throws Exception {
        return super.uploadFileAndGetChecksum(file);
    }
    @ApiOperation("upload multiple documentIndexElements")
    @RequestMapping(value = "upload-multiple", method = RequestMethod.POST, consumes = "multipart/form-data")
    public ResponseEntity<List<FileTempDto>> uploadMultipleFileAndGetChecksum(@RequestBody MultipartFile[] files) throws Exception {
        return super.uploadMultipleFileAndGetChecksum(files);
    }

    @ApiOperation("Finds a list of all documentIndexElements")
    @GetMapping("")
    ...
    @ApiOperation("Finds a documentIndexElement by id")
    @GetMapping("id/{id}")
    ...
    @ApiOperation("Delete the specified documentIndexElement")
    @DeleteMapping("")
    ...
    @ApiOperation("Delete multiple documentIndexElements by ids")
    ...
    @ApiOperation("Finds documentIndexElements by criteria")
    ...
    @ApiOperation("Finds paginated documentIndexElements by criteria")
    ...
    @ApiOperation("Exports documentIndexElement history by criteria")
    ...
    @ApiOperation("Gets documentIndexElement history data size by criteria")
