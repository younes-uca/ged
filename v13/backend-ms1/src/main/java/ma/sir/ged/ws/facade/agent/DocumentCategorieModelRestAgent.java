...
@RestController
@RequestMapping("/api/agent/documentCategorieModel/")
public class DocumentCategorieModelRestAgent  extends AbstractController<DocumentCategorieModel, DocumentCategorieModelDto, DocumentCategorieModelHistory, DocumentCategorieModelCriteria, DocumentCategorieModelHistoryCriteria, DocumentCategorieModelAgentService, DocumentCategorieModelConverter> {
    ...
    public DocumentCategorieModelRestAgent (DocumentCategorieModelAgentService service, DocumentCategorieModelConverter converter) {
