...
import Edit from '../edit/document-categorie-field-rule-edit-agent.component';
import Create from '../create/document-categorie-field-rule-create-agent.component';
import View from '../view/document-categorie-field-rule-view-agent.component';
...
const List = () => {
    ...
    const fetchItems = async (criteria) => {
        try {
            const response = await DocumentCategorieFieldRuleAgentService.findPaginatedByCriteria(criteria);
   ...
   const hideDeleteItemsDialog = () => {
    ...
    const deleteItem = async () => {
        try{
            await DocumentCategorieFieldRuleAgentService.delete(selectedItem?.id);
            setDeleteItemDialog(false);
            setItem(emptyItem);
    ...
    const deleteSelectedItems = async () => {
        await DocumentCategorieFieldRuleAgentService.deleteList(selectedItems);
