...
import useViewhook from "../../../../../zyhooks/useViewhook";
        ...
        <Dialog visible={visible} style={{width: '70vw'}} header={t("documentTabPan")} modal className="p-fluid"
            ...
            <TabView activeIndex={activeIndex} onTabChange={onTabChange}>
                <TabPanel header={t("documentTabPan")}>
                    <div className="formgrid grid">
                        ...
                        <div className="field col-6">
                            ...
                            <Calendar id="uploadDate" value={adaptDate(selectedItem?.uploadDate)} disabled
                                      dateFormat="dd/mm/yy" showIcon={true}/>
                        </div>

                        <div className="field col-6">
                            <label htmlFor="dateLastUpdate">{t("documentDateLastUpdate")}</label>
                            <Calendar id="dateLastUpdate" value={adaptDate(selectedItem?.dateLastUpdate)} disabled
                                      dateFormat="dd/mm/yy" showIcon={true}/>
                        </div>
                        ...
                        <div className="field col-6">
                            ...
                            <InputText id="documentStateDropdown" value={selectedItem?.documentState?.libelle}
                                       disabled/>
                        </div>
                        <div className="field col-6">
                            <label htmlFor="documentCategorie">{t("documentDocumentCategorie")}</label>
                            <InputText id="documentCategorieDropdown" value={selectedItem?.documentCategorie?.libelle}
                                       disabled/>
                        </div>
                        <div className="field col-6">
                ...
                <TabPanel header={t("documentDocumentPartageGroupes")}>
                    <div className="card">
                        <DataTable value={selectedItem?.documentPartageGroupes} tableStyle={{minWidth: '50rem'}}
                                   dataKey="id">
                ...
                <TabPanel header={t("documentDocumentPartageUtilisateurs")}>
                    <div className="card">
                        <DataTable value={selectedItem?.documentPartageUtilisateurs} tableStyle={{minWidth: '50rem'}}
                                   dataKey="id">
