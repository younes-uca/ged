...
import useCreateHook from "app/component/zyhooks/useCreate.hook";
...
type DocumentCreateAdminType = {
    ...
    list: DocumentDto[],
    t: TFunction,
    service: AbstractService<DocumentDto, DocumentCriteria>
}
const Create: React.FC<DocumentCreateAdminType> = ({visible, onClose, add, showToast, list, t, service}) => {
    ...
    return (
        <Dialog visible={visible} style={{width: '70vw'}} header={t("documentTabPan")} modal className="p-fluid"
                    ...
                    <div className="formgrid grid">
                        ...
                        <div className="field col-6">
                            <FileUpload name="referenceGed" url={"http://localhost:8037/minio/upload/file/ged"}
                                        maxFileSize={1000000}
                                        emptyTemplate={<p className="m-0">vous pouvez glisser deposer votre
                                            document</p>}/>
                        </div>
                        <div className="field col-6">
                        ...
                        <div className="field col-6">
                            ...
                            <Calendar id="dateLastUpdate" value={item.dateLastUpdate}
                                      onChange={(e) => onInputDateChange(e, 'dateLastUpdate')} dateFormat="dd/mm/yy"
                                      showIcon={true}/>
                        </div>
                        <div className="field col-6">
                            <label htmlFor="content">{t("documentContent")}</label>
                            <InputText id="content" value={item.content}
                                       onChange={(e) => onInputTextChange(e, 'content')} required autoFocus
                                       className={classNames({'p-invalid': submitted && !item.content})}/>
                        ...
                        <InputSwitch id="folder" checked={item.folder}
                                     onChange={(e) => onBooleanInputChange(e, 'folder')}/>
                        </span>
                            </div>
                        </div>
                        <div className="field col-6">
                        ...
                        <div className="field col-6">
                            ...
                            <Dropdown id="documentTypeDropdown" value={item.documentType} options={documentTypes}
                                      onChange={(e) => onDropdownChange(e, 'documentType')}
                                      placeholder={t("documentDocumentTypePlaceHolder")} filter
                                      filterPlaceholder={t("documentDocumentTypePlaceHolderFilter")}
                                      optionLabel="libelle"/>
                        </div>
                        <div className="field col-6">
                            <label htmlFor="documentState">{t("documentDocumentState")}</label>
                            <Dropdown id="documentStateDropdown" value={item.documentState} options={documentStates}
                                      onChange={(e) => onDropdownChange(e, 'documentState')}
                                      placeholder={t("documentDocumentStatePlaceHolder")} filter
                        ...
                        <div className="field col-6">
                            ...
                            <Dropdown id="documentCategorieDropdown" value={item.documentCategorie}
                                      options={documentCategories}
                                      onChange={(e) => onDropdownChange(e, 'documentCategorie')}
                                      placeholder={t("documentDocumentCategoriePlaceHolder")} filter
                        ...
                        <div className="field col-6">
                            ...
                            <Dropdown id="utilisateurDropdown" value={item.utilisateur} options={utilisateurs}
                                      ...
                                      placeholder={t("documentUtilisateurPlaceHolder")} filter
                                      filterPlaceholder={t("documentUtilisateurPlaceHolderFilter")} optionLabel="nom"/>
                        </div>
                        <div className="field col-6">
                            <div className="label-inputswitch">
                                <label htmlFor="archive">{t("documentArchive")}</label>
                                <span className="p-float-label">
                        <InputSwitch id="archive" checked={item.archive}
                                     onChange={(e) => onBooleanInputChange(e, 'archive')}/>
                        </span>
                            </div>
                        </div>
                        <div className="field col-6">
                            <div className="label-inputswitch">
                                ...
                                <span className="p-float-label">
                        <InputSwitch id="versionne" checked={item.versionne}
                                     onChange={(e) => onBooleanInputChange(e, 'versionne')}/>
                        </span>
                            </div>
                        </div>
                        <div className="field col-6">
                            <label htmlFor="entiteAdministrative">{t("documentEntiteAdministrative")}</label>
                            <Dropdown id="entiteAdministrativeDropdown" value={item.entiteAdministrative}
                                      options={entiteAdministratives}
                                      onChange={(e) => onDropdownChange(e, 'entiteAdministrative')}
                                      placeholder={t("documentEntiteAdministrativePlaceHolder")} filter
                        ...
                        <TabPanel header={t("creation")}>
                            <div className="grid">
                                <div className="field col-5">
                                    ...
                                    <Dropdown id="fieldDropdown" value={documentFields.field} options={fields}
                                              onChange={(e) => onDropdownChangeDocumentFields(e, 'field')}
                                              placeholder={t("documentFieldFieldPlaceHolder")} filter
                                              filterPlaceholder={t("documentFieldFieldPlaceHolderFilter")}
                                              optionLabel="libelle"/>
                                </div>
                                <div className="field col-6">
                                    <label htmlFor="value">{t("documentFieldValue")}</label>
                                    <InputText id="value" value={documentFields.value}
                                               onChange={(e) => onInputTextChangeDocumentFields(e, 'value')} required
                                               autoFocus
                                               className={classNames({'p-invalid': submitted && !item.documentFields})}/>
                                </div>
                                <div className="field col-5">
                                    <label htmlFor="documentFieldState">{t("documentFieldDocumentFieldState")}</label>
                                    <Dropdown id="documentFieldStateDropdown" value={documentFields.documentFieldState}
                                              options={documentFieldStates}
                                              onChange={(e) => onDropdownChangeDocumentFields(e, 'documentFieldState')}
                                              placeholder={t("documentFieldDocumentFieldStatePlaceHolder")} filter
                                              filterPlaceholder={t("documentFieldDocumentFieldStatePlaceHolderFilter")}
                                              optionLabel="libelle"/>
                                </div>
                            ...
                            <div className="grid">
                                <div className="field col-6">
                                    ...
                                    <Dropdown id="groupeDropdown" value={documentPartageGroupes.groupe}
                                              ...
                                              placeholder={t("documentPartageGroupeGroupePlaceHolder")} filter
                                              filterPlaceholder={t("documentPartageGroupeGroupePlaceHolderFilter")}
                                              optionLabel="libelle"/>
                                </div>
                                <div className="field col-6">
                                    <label htmlFor="dateShare">{t("documentPartageGroupeDateShare")}</label>
                                    <Calendar id="dateShare" value={documentPartageGroupes.dateShare}
                                ...
                                <div className="field col-6">
                                    ...
                                    <Dropdown id="accessShareDropdown" value={documentPartageGroupes.accessShare}
                                              ...
                                              placeholder={t("documentPartageGroupeAccessSharePlaceHolder")} filter
                                              filterPlaceholder={t("documentPartageGroupeAccessSharePlaceHolderFilter")}
                                              optionLabel="libelle"/>
                                </div>
                                <div className="field col-1">
                                    <Button icon="pi pi-plus" label="OK" className="mt-4"
                                            onClick={addDocumentPartageGroupes}/>
                                </div>
                            </div>
                        </TabPanel>
                        <TabPanel header={t("list")}>
                            <div className="card">
                                <DataTable value={item.documentPartageGroupes} tableStyle={{minWidth: '50rem'}}
                                    ...
                                    <Column field="dateShare" header={t("documentPartageGroupeDateShare")}
                                            body={formateDate("dateShare")}></Column>
                                    <Column field="accessShare.libelle"
                                            header={t("documentPartageGroupeAccessShare")}></Column>
                                    <Column header={t("actions")} body={(rowData) => (<div>
                                        <Button icon="pi pi-times" rounded severity="warning"
                                                className="mr-2 p-button-danger"
                                                onClick={() => deleteDocumentPartageGroupes(rowData)}/>
                                        <Button icon="pi pi-pencil" rounded severity="success" className="mr-2"
                                                onClick={() => editDocumentPartageGroupes(rowData)}/></div>)}></Column>
                                </DataTable>
                            </div>
                        </TabPanel>
                    </TabView>
                            ...
                            <div className="grid">
                                <div className="field col-6">
                                    ...
                                    <Dropdown id="utilisateurDropdown" value={documentPartageUtilisateurs.utilisateur}
                                              ...
                                              placeholder={t("documentPartageUtilisateurUtilisateurPlaceHolder")} filter
                                              filterPlaceholder={t("documentPartageUtilisateurUtilisateurPlaceHolderFilter")}
                                              optionLabel="nom"/>
                                </div>
                                <div className="field col-6">
                                    <label htmlFor="dateShare">{t("documentPartageUtilisateurDateShare")}</label>
                                    <Calendar id="dateShare" value={documentPartageUtilisateurs.dateShare}
                                ...
                                <div className="field col-6">
                                    ...
                                    <Dropdown id="accessShareDropdown" value={documentPartageUtilisateurs.accessShare}
                                              ...
                                              placeholder={t("documentPartageUtilisateurAccessSharePlaceHolder")} filter
                                              filterPlaceholder={t("documentPartageUtilisateurAccessSharePlaceHolderFilter")}
                                              optionLabel="libelle"/>
                                </div>
                                <div className="field col-1">
                                    <Button icon="pi pi-plus" label="OK" className="mt-4"
                                            onClick={addDocumentPartageUtilisateurs}/>
                                </div>
                            </div>
                        </TabPanel>
                        <TabPanel header={t("list")}>
                            <div className="card">
                                <DataTable value={item.documentPartageUtilisateurs} tableStyle={{minWidth: '50rem'}}
                                    ...
                                    <Column field="utilisateur.nom"
                                            header={t("documentPartageUtilisateurUtilisateur")}></Column>
                                    <Column field="dateShare" header={t("documentPartageUtilisateurDateShare")}
                                            body={formateDate("dateShare")}></Column>
                                    <Column field="accessShare.libelle"
                                            header={t("documentPartageUtilisateurAccessShare")}></Column>
                                    <Column header={t("actions")} body={(rowData) => (<div>
                                        <Button icon="pi pi-times" rounded severity="warning"
                                                className="mr-2 p-button-danger"
